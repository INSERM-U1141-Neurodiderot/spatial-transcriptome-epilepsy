...
plotVisiumQval <- function(spe_obj, scpa_save_dir, sample_ids, complete_pathway_name, name_replicate, spat_vis_dir) {
    ...
    # Plot above the colored clustering
...
### GOBP : REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT
output_dir_spat_GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT <- sprintf("%s/GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT", spatial_SCPA_vis_human)
if (! dir.exists(output_dir_spat_GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT)) {
    dir.create(output_dir_spat_GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT, recursive=TRUE, mode="0775")
}
complete_pathway_name <- "GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT"

## Replicates samples - CTRL
### 1st replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_1st_repli_CTRL, complete_pathway_name = complete_pathway_name, name_replicate = "1st_replicates_CTRL", spat_vis_dir = output_dir_spat_GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT)
### 2nd replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_2nd_repli_CTRL, complete_pathway_name = complete_pathway_name, name_replicate = "2nd_replicates_CTRL", spat_vis_dir = output_dir_spat_GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT)
## Replicates samples - SE
### 1st replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_1st_repli_SE, complete_pathway_name = complete_pathway_name, name_replicate = "1st_replicates_SE", spat_vis_dir = output_dir_spat_GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT)
### 2nd replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_2nd_repli_SE, complete_pathway_name = complete_pathway_name, name_replicate = "2nd_replicates_SE", spat_vis_dir = output_dir_spat_GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT)
## Custom grouping
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_custom, complete_pathway_name = complete_pathway_name, name_replicate = "custom", spat_vis_dir = output_dir_spat_GOBP_REGULATION_OF_NERVOUS_SYSTEM_DEVELOPMENT)

### GOBP : POSITIVE_REGULATION_OF_GLIOGENESIS
output_dir_spat_GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS <- sprintf("%s/GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS", spatial_SCPA_vis_human)
if (! dir.exists(output_dir_spat_GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS)) {
    dir.create(output_dir_spat_GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS, recursive=TRUE, mode="0775")
}
complete_pathway_name <- "GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS"

## Replicates samples - CTRL
### 1st replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_1st_repli_CTRL, complete_pathway_name = complete_pathway_name, name_replicate = "1st_replicates_CTRL", spat_vis_dir = output_dir_spat_GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS)
### 2nd replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_2nd_repli_CTRL, complete_pathway_name = complete_pathway_name, name_replicate = "2nd_replicates_CTRL", spat_vis_dir = output_dir_spat_GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS)
## Replicates samples - SE
### 1st replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_1st_repli_SE, complete_pathway_name = complete_pathway_name, name_replicate = "1st_replicates_SE", spat_vis_dir = output_dir_spat_GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS)
### 2nd replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_2nd_repli_SE, complete_pathway_name = complete_pathway_name, name_replicate = "2nd_replicates_SE", spat_vis_dir = output_dir_spat_GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS)
## Custom grouping
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_custom, complete_pathway_name = complete_pathway_name, name_replicate = "custom", spat_vis_dir = output_dir_spat_GOBP_POSITIVE_REGULATION_OF_GLIOGENESIS)

### GOBP : NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT
output_dir_spat_GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT <- sprintf("%s/GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT", spatial_SCPA_vis_human)
if (! dir.exists(output_dir_spat_GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT)) {
    dir.create(output_dir_spat_GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT, recursive=TRUE, mode="0775")
}
complete_pathway_name <- "GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT"

## Replicates samples - CTRL
### 1st replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_1st_repli_CTRL, complete_pathway_name = complete_pathway_name, name_replicate = "1st_replicates_CTRL", spat_vis_dir = output_dir_spat_GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT)
### 2nd replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_2nd_repli_CTRL, complete_pathway_name = complete_pathway_name, name_replicate = "2nd_replicates_CTRL", spat_vis_dir = output_dir_spat_GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT)
## Replicates samples - SE
### 1st replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_1st_repli_SE, complete_pathway_name = complete_pathway_name, name_replicate = "1st_replicates_SE", spat_vis_dir = output_dir_spat_GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT)
### 2nd replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_2nd_repli_SE, complete_pathway_name = complete_pathway_name, name_replicate = "2nd_replicates_SE", spat_vis_dir = output_dir_spat_GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT)
## Custom grouping
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_custom, complete_pathway_name = complete_pathway_name, name_replicate = "custom", spat_vis_dir = output_dir_spat_GOBP_NEGATIVE_REGULATION_OF_NEURON_PROJECTION_DEVELOPMENT)

### GOBP : ASTROCYTE_DEVELOPMENT
output_dir_spat_GOBP_ASTROCYTE_DEVELOPMENT <- sprintf("%s/GOBP_ASTROCYTE_DEVELOPMENT", spatial_SCPA_vis_human)
if (! dir.exists(output_dir_spat_GOBP_ASTROCYTE_DEVELOPMENT)) {
    dir.create(output_dir_spat_GOBP_ASTROCYTE_DEVELOPMENT, recursive=TRUE, mode="0775")
}
complete_pathway_name <- "GOBP_ASTROCYTE_DEVELOPMENT"

## Replicates samples - CTRL
### 1st replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_1st_repli_CTRL, complete_pathway_name = complete_pathway_name, name_replicate = "1st_replicates_CTRL", spat_vis_dir = output_dir_spat_GOBP_ASTROCYTE_DEVELOPMENT)
### 2nd replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_2nd_repli_CTRL, complete_pathway_name = complete_pathway_name, name_replicate = "2nd_replicates_CTRL", spat_vis_dir = output_dir_spat_GOBP_ASTROCYTE_DEVELOPMENT)
## Replicates samples - SE
### 1st replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_1st_repli_SE, complete_pathway_name = complete_pathway_name, name_replicate = "1st_replicates_SE", spat_vis_dir = output_dir_spat_GOBP_ASTROCYTE_DEVELOPMENT)
### 2nd replicates
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_2nd_repli_SE, complete_pathway_name = complete_pathway_name, name_replicate = "2nd_replicates_SE", spat_vis_dir = output_dir_spat_GOBP_ASTROCYTE_DEVELOPMENT)
## Custom grouping
plotVisiumQval(spe_obj = spe_human, scpa_save_dir = scpa_human, sample_ids = sample_ids_custom, complete_pathway_name = complete_pathway_name, name_replicate = "custom", spat_vis_dir = output_dir_spat_GOBP_ASTROCYTE_DEVELOPMENT)